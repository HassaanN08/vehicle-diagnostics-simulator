...
void udsRequestParserTests() {
    ...
    assert(responsePayload[0] == 0x7F && responsePayload[1] == 0x10 && responsePayload[2] == 0x13 && responsePayload[3] == 0x03 && responsePayload[4] == 0x11);

    responsePayload = UDSRequestParser::parser(engine, {0x12, 0x22});

    assert(responsePayload[0] == 0x7F && responsePayload[1] == 0x12 && responsePayload[2] == 0x11 && responsePayload[3] == 0x22);

    responsePayload = UDSRequestParser::parser(brake, {0x10, 0x22});

    assert(responsePayload[0] == 0x7F && responsePayload[1] == 0x10 && responsePayload[2] == 0x11 && responsePayload[3] == 0x22);
